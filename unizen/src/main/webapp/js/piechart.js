 $(document).ready(function() {
        $('.example').mouseover(function() {
           $('.example .all-value').css({display: 'none'});
        });
		 $('.example').mouseout(function() {
           $('.example .all-value').css({display: 'block'});
		   $('.piehole-text').css({display: 'none'});
        });
		
		$('.example2').mouseover(function() {
           $('.example2 .all-value').css({display: 'none'});
        });
		$('.example2').mouseout(function() {
           $('.example2 .all-value').css({display: 'block'});
		   $('.piehole-text').css({display: 'none'});
        });
		$('.example3').mouseover(function() {
           $('.example3 .all-value').css({display: 'none'});
        });
		$('.example3').mouseout(function() {
           $('.example3 .all-value').css({display: 'block'});
		   $('.piehole-text').css({display: 'none'});
        });
		$('.example4').mouseover(function() {
           $('.example4 .all-value').css({display: 'none'});
        });
		$('.example4').mouseout(function() {
           $('.example4 .all-value').css({display: 'block'});
		   $('.piehole-text').css({display: 'none'});
        });
		$('.example5').mouseover(function() {
           $('.example5 .all-value').css({display: 'none'});
        });
		$('.example5').mouseout(function() {
           $('.example5 .all-value').css({display: 'block'});
		   $('.piehole-text').css({display: 'none'});
        });
		$('.example6').mouseover(function() {
           $('.example6 .all-value').css({display: 'none'});
        });
		$('.example6').mouseout(function() {
           $('.example6 .all-value').css({display: 'block'});
		   $('.piehole-text').css({display: 'none'});
        });
...
$(document).ready(function() {
	...
	$(".piechart-flatmin").on('mouseenter','.sector-s',clickState);
	//$(".piechart-flatmin").on('mouseout','.sector-s',clickStateout);
...
/* if(".example"){
    	 ...
    	 pieHole = $('<div class="piehole">ajo test</div>');
 } else if(".example2"){
	  pieHole = $('<div class="piehole">ajus</div>');
 }*/
 
 
 		pieHole = $('<div class="piehole"></div>');
